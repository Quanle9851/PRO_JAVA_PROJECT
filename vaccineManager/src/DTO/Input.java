...
public class Input {
    ...
    public static LocalDate inputValidDate1(String msg){
        String data;
        do{
           System.out.print(msg);
           data= sc.nextLine().trim();
    ...
    public static LocalDate inputValidDate2(String msg, LocalDate date1){
        String data;
    ...
    public static String StudentID(String msg, StudentList stulist){
        String data;
        do{
           System.out.print(msg);
           data= sc.nextLine().trim().toUpperCase();
           if (!stulist.isIDExist(data)) 
               System.out.println("Student not exist");
           else if (stulist.search(data).getInjNum() >= 1) 
               System.out.println("This student has injected the maximum number of injection or waiting for second dose ");
        }while (!stulist.isIDExist(data) || stulist.search(data).getInjNum() >= 1);
        return data; 
    }
    
    public static String StudentIDToSearch(String msg, StudentList stulist){
        String data;
        do{
           System.out.print(msg);
           data= sc.nextLine().trim();
    ...
    public static String VaccineID(String msg, VaccineList vaclist){
        String data;
        do{
           System.out.print(msg);
           data= sc.nextLine().trim();
