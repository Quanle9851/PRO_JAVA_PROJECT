...
public class HuffmanTree {
    ...
    public HuffmanTree(FreqCounter fTable) {
        this.freqTable = fTable;
        createTree();
    }
    ...
    private void createTree(){
        ...
        while (n>1){
            ...
            treeList.remove(n-2);
            i=n-3;
            while (i>=0 && treeList.get(i).freq<=newNode.freq) i--;
    ...
    public void reBuild(int symbol, String codeword){
        ...
        for (int i=0; i<codeword.length()-1; i++){
            ...
            if (digit=='0'){
                ...
                if (t.right == null) t.left = createIntermediate(0);
                t=t.right;
            }
        }
        TreeNode newNode = new TreeNode(symbol,0);
        if (lastBit =='0') t.left = newNode;
